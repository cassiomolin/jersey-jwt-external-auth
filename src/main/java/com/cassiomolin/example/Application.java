...
import com.cassiomolin.example.api.JerseyConfiguration;
...
public class Application {
    ...
    public static void main(final String[] args) {
        ...
        startServer(Strings.isNullOrEmpty(port) ? DEFAULT_PORT : Integer.valueOf(port));
    }
        ...
        DeploymentInfo servletBuilder = Servlets.deployment()
                ...
                .addServlets(
                        Servlets.servlet("jerseyServlet", ServletContainer.class)
                                .setLoadOnStartup(1)
                                .addInitParam("javax.ws.rs.Application", JerseyConfiguration.class.getName())
                                .addMapping("/api/*"))
